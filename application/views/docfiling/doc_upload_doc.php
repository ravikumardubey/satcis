 ...
 <?php 
            ...
            form_fieldset('Document Upload').
              ...
              '<div class="date-div text-success"></div>';
                ...
                <div class="col-md-12">
                 <span style="color:red">Documents shall be uploaded after bookmarking only.</span>
                  <h3 class="text-info">All Files should be in pdf format only. <sup class="text-danger">*</sup></h3>
				</div>
                <div class="col-md-12">
                  <div class="row rdoc">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2"> Document Type <sup class="text-danger">*</sup> </div>
                    <?php 
                    $filingval='';
                    $vaba='';
                 ...
                 <div class="row rdoc" id="matter" style="display:none">
                      	<div class="col-md-2">
                         Matter<sup class="text-danger">*</sup>
                        </div>
                        <div class="col-md-4">
                      ...
                      complete: function(){
                        listUpdFiles();
                          	setTimeout(function(){ 
        		                   ...
        		                   $('#rightbar').empty().load(base_url+'/loadpage/doc_upload_doc'); 
                         }, 500); 
                      }
                    });
                }
...
$('#documentUpload').submit(function(e){
 ...
 var token_hash=HASH(token+'docsave');
 
  $.ajax({
    type: "POST",
    url: base_url+"doc_save_nextDoc/"+token_hash,
    data: {salt:salt, token:token, tabno:tabno, untak:untak},
    dataType: 'json',
    beforeSend: function(){
		$('#documentSave').prop('disabled',true).val("Under proccess....");
	},
    success: function (resp) {
      if(resp.data=='success') {
        ...
        $('#documentSave').prop('disabled',false).val("Submit");
      }
    },
