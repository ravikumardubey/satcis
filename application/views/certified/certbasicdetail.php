    			  ...
    			  <div class="col-md-3">
                   ...
                   <div class="col-md-3">
                         <div class=" col-md-3" style="margin-top: 29px;">
                			<input type="button" name="nextsubmit" value="SEARCH" class="btn btn-success" id="nextsubmit" onclick="serchDFRCert();">
                        </div>
    			  </div>
             </div>
             <?php 
          ...
          <div style="margin-top:50px">
    		...
    		<div class="row">
                <div class="offset-md-8 col-md-4">
                    <input type="button" value="Save and Next" class="btn btn-success"  id="petitioner_save1" onclick="certSubmitBasic();">
...
function certSubmitBasic(){
    ...
    var token_hash=HASH(token+'certcopybasic');
	...
	$.ajax({
        type: "POST",
        url: base_url+'saveCertbasic/'+token_hash,
        data: dataa,
        cache: false,
		beforeSend: function(){
			$('#petitioner_save1').prop('disabled',true).val("Under proccess....");
		},
