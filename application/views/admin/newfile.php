  ...
  <div class="row">
    <div class="col-lg-12 mx-auto">
      ...
      <?php 
        ...
        <!-- -Start Regulator -->
    	<div class="card">
          	<div id="collapse1" class="card-header bg-white shadow-sm border-0">
            	<h6 class="mb-0 font-weight-bold"><a href="#" data-toggle="collapse" data-target="#collapse1" aria-expanded="false"  	
            	aria-controls="collapse1" class="d-block position-relative collapsed ">Regulator Detail</a></h6>
          	</div>
          	<div class="massagebasic" style="color:green;text-align: center;"></div>
      			<div id="collapse1" aria-labelledby="heading1" data-parent="#collapse1" class="collapse">
        			<div class="card-body ">
          				<div class="content" style="padding-top:0px;">
                    		<div class="row">
                    			<div class="card" style="width: 100%; order-top: 0px;margin-top: 0px; border-top-right-radius: 0px; border-top-left-radius: 0px;">
                    	        ...
                    	        <div class="row">
                    	        	<div class="col-md-3">
                    					...
                    					<div class="input-group mb-3 mb-md-0">
                                        <input name="impugned_no" id="impugned_no" maxlength="15" placeholder="Impugned Order Number" class="form-control"    value="<?php echo $iordernumber; ?>"> 
                    					</div>
                    				</div>
        ...
        <div class="card">
          ...
          <div id="collapseOne" aria-labelledby="headingOne" data-parent="#accordionExample" class="collapse ">
            <div class="card-body">
                ...
                <input type="button" id="nextsubmit" value="Update Applicant" class="btn btn-primary" onclick="up_date();">		
            </div>
        </div>
      </div>  
         <!-- -End  Applicant  --> 
            ...
            class="d-block position-relative collapsed">Respondent</a></h6>
      		...
      		<div id="collapseTwo" aria-labelledby="headingTwo" data-parent="#accordionExample" class="collapse">
        		<div class="card-body">
        			<div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group required">
                                ...
                                <label>District:<span class="text-danger">*</span></label>                    
                    	        <?php
                                   echo form_dropdown('ddistrictname',@$city1,@$dist_code_resp,['class'=>'form-control','id'=>'ddistrictname']);  ?>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                    ...
                    <input type="button" name="nextsubmitres" id="nextsubmitres" value="Update Respondent" class="btn btn-primary btn-md" onclick="up_dateres();">       
       			 </div>
            </div>
         </div>   
        ...
        <!-- Accordion item 3 -->
   		<div class="card">
          		...
          		<div id="collapseThreee" aria-labelledby="headingThree" data-parent="#accordionExample" class="collapse">
            		<div class="card-body ">
                        ...
                        <input type="button" name="councelsubmit" id="councelsubmit" value="Update Counsel" class="btn btn-primary btn-md" onclick="up_councel();">
                  	</div>
               </div>
           </div>    
	           <!-- --Councel end -->
	           
	          <?php //echo "select * from sat_case_detail where filing_no='$filing_no'"; ?> 
	       <!-- --Ma Detail start --> 
            <div class="card">
              	<div id="headingma" class="card-header bg-white shadow-sm border-0">
                	<h6 class="mb-0 font-weight-bold"><a href="#" data-toggle="collapse" data-target="#collapseMA" aria-expanded="false"  	aria-controls="collapseMA" class="d-block position-relative collapsed ">MA Detail</a></h6>
              	</div>
          		<div id="collapseMA" aria-labelledby="headingma" data-parent="#collapseMA" class="collapse">
            		<div class="card-body ">
              			<div class="row">
	     ...
	     <div class="card">
      		...
      		<div id="collapse5" aria-labelledby="heading5" data-parent="#collapse5" class="collapse">
        		<div class="card-body ">
          			<div class="row">
                         <div class="col-md-4">
        					<div required">
