			...
			<div class="panel-body">
				<table class="responstable" width="100%" cellpadding="0"	cellspacing="0" align="center" border="1px">
					<tbody>
						...
						<tr>
							<td><strong>SAT Location</strong></td>
		...
		<div id="collapseFour1" role="tabpanel" aria-labelledby="headingThree" style="display: block;">
			<div class="panel-body">
				<table class="responstable" width="100%" cellpadding="0"	cellspacing="0" align="center" border="1px">
						...
						<?php $comm =$this->efiling_model->data_list_where('additional_commision','filing_no',$filing_no);
						if(!empty($comm)){
						$i=1;
				...
				<table id="table" class="responstable" width="100%" cellpadding="0"	cellspacing="0" border="1px">
					...
					if(!empty($stQ)){
					    ...
					    foreach($stQ as $doc){
							...
							$encrypted = myCrypt($doc->file_url, $key, $vector);
							?>
						<tr>
							<td><?php echo $i; ?></td>
							...
							<td><a target="_blank"	href="<?php echo base_url(); ?>order_view/<?php echo base64_encode($encrypted); ?>" target="_blank">View</a></td>
						</tr>
					<?php 
					$i++;  }
					}else{
			...
			<div class="panel-body">
				<table id="table" class="responstable" width="100%" cellpadding="0"	cellspacing="0" border="1px">
					...
					if(!empty($ias)){
						...
						<tr>
							<td><?php echo $i; ?></td>
							<td>IA-<?php echo $ia->ia_no;; ?>/<?php echo substr($ia_fil_no_unq, 11, 4); ?></td>
