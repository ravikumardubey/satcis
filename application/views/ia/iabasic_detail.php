    		...
    		?>
			  	<div class="col-md-3">
                     <div class="form-group required">
						...
						<input type="radio" name="appAnddef" onclick="diaryforia();" id="app" value="1" <?php echo $checked1; ?>> 
					 </div>
				</div>
			    <div class="col-md-3">
                    <div class="form-group required">
						<label for="name"><span class="custom"><font color="red">*</font></span>Case No </label> 
						<input type="radio" name="appAnddef" onclick="diaryforia();" id="def" value="2" <?php echo $checked2; ?>> 
					</div>
				</div> 
			 </div>     
    			  ...
    			  <div class="col-md-3">
                   ...
                   <div class="col-md-3">
                         <div class=" col-md-3" style="margin-top: 29px;">
                			<input type="button" name="nextsubmit" value="SEARCH" class="btn btn-success" id="nextsubmit" onclick="serchDFRIa();">
                        </div>
    			  </div>
             </div>
             <?php 
      ...
      <fieldset id="" style="display: block">
        <legend class="customlavelsub">Case Details</legend>
          <div style="">
    		...
    		<div class="row">
                <div class="offset-md-9 col-md-3" style="">
...
function serchDFRIa(){
	...
	action = base_url+"iabasic_detail";
	submit();
    	document.rpepcpbascidetail.nextsubmit.disabled = true;  
     	document.rpepcpbascidetail.nextsubmit.value = 'Please Wait...';  
     	return true;
	}
}
