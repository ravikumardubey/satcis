...
$status='';
if($filing_no!=''){
    $basicia= $this->efiling_model->data_list_where('sat_case_detail','filing_no',$filing_no);
...
<div id="rightbar"> 
	<form action="#" id="frmCounsel" autocomplete="off">    
        ...
        <div class="content" style="padding-top:0px;">
    		<fieldset id="iaNature" style="display:block"><legend class="customlavelsub">MA Details</legend>
    		 		<div class="col-md-2">
                        <div><label for="phone"><span class="custom"><font color="red">*</font>Total No Of MA:</span></label></div>
                        ...
                        <thead>
                              ...
                              <tbody>
                               <?php 
                                ...
                                <tr>
                                     <td><?php echo $i;?></td>
                                      <td><input type="checkbox" name="natureCode" value ="<?php echo htmlspecialchars($row->nature_code); ?>" onclick="openTextBox(this);"></td>
